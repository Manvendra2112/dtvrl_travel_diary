...
class DeleteProfileSuccessScreen extends StatelessWidget {
  const DeleteProfileSuccessScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Image.asset(
            ImageAssets.tickIconRed, // Replace with actual tick icon asset
            height: 120,
            width: 120,
            errorBuilder: (context, error, stackTrace) => Icon(
              Icons.check_circle,
